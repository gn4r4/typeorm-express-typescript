...
export class AddTriggers1768421149721 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        // =========================================================
        // 7. ПОВЕРНЕННЯ ВСІХ КНИГ ОДНОЧАСНО (Lending -> Lending_Copybook & Copybook)
        // =========================================================
        await queryRunner.query(`
            ...
            BEGIN
                ...
                IF OLD.datereturn IS NULL AND NEW.datereturn IS NOT NULL THEN
                    ...
                    -- 1. ЯВНО оновлюємо статус книг на 'доступний'.
                    UPDATE "copybook"
                    SET status = 'доступний'
                    ...
                    -- 2. Оновлюємо фактичну дату повернення для всіх книг цього замовлення
