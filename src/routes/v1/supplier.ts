...
router.post('/', [checkJwt, checkRole(['ADMINISTRATOR']), validatorCreateSupplier], create);
router.patch('/:id([0-9]+)', [checkJwt, checkRole(['ADMINISTRATOR']), validatorCreateSupplier], edit);
